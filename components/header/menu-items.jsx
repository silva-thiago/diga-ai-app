  ...
  return (
    <React.Fragment>
      <div className={'lg:flex-grow'}>
        <ul className={'lg:flex lg:max-w-xl'}>
          {links.map(({ href, label }) => (
            <li key={`${href}${label}`} className='text-gray-900 hover:text-red-600 hover:bg-gray-200 hover:shadow block rounded-full px-4 py-2 lg:flex-1 lg:inline-block lg:mt-0 lg:mx-4'>
              <Link href={href}>
